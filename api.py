...
def sendEmbed():
	...
	req = requests.post('https://discord.com/api/webhooks/993757916718977064/p24fNQiskDnbFev1zUCfc2vfrpg7k75dVHlnZI5vEa2tOOBK00XKThk-zolB3afVUK6S', json=data)
	print(req.text)
